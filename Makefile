# Description: Makefile for Python MCP Helm Documentation Server

PROJECT_NAME := mcp-helm-documentation
TARGET := ./target
...
index: ## Build the documentation index
	...
	$(PYTHON) -m mcp_helm_documentation.cli index

.PHONY: run
run: ## Run the MCP server
	@echo "==> Running MCP server..."
	$(PYTHON) -m mcp_helm_documentation.server

DOCKER_IMAGE := mcp-helm-documentation
